...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="<?= base_url('assets/package') ?>/img/apple-icon.png">
  <link rel="icon" type="image/png" href="<?= base_url('assets/package') ?>/img/favicon.png">
  <title>
    Title
  </title>
  <!--     Fonts and icons     -->
...
<body class="g-sidenav-show   bg-gray-100">
  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/argon-dashboard/pages/dashboard.html " target="_blank">
        <img src="<?= base_url('assets/package') ?>/img/logo-ct-dark.png" class="navbar-brand-img h-100" alt="main_logo">
  ...
  <script src="<?= base_url('assets/package') ?>/js/argon-dashboard.min.js?v=2.0.4"></script>
</body>
